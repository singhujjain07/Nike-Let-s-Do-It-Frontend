...

                {
                    auth.user ? (
                        ...
                        <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-x-4">
                            ...
                            <Link to="/login" className={`flex items-center text-md font-montserrat font-semibold leading-normal text-gray-900 hover:border-b-2 ${!scrolled ? "border-[#FF6452]" : "border-white"}`}>
