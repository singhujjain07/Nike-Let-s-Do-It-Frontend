...
Command: npx gltfjsx@6.2.16 shoe7.gltf --transform 
Files: shoe7.gltf [5.34MB] > D:\Babadon\WEBD\ThreeJS\Nike-Let's Do It!\shoe7\shoe7-transformed.glb [926.94KB] (83%)
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/shoe7-transformed.glb')
  return (
...
useGLTF.preload('/shoe7-transformed.glb')
